...
import { message, Layout, Typography, Form, List, InputNumber, Input, Switch, Radio, Button, Tag } from "antd";
              ...
              getFieldValue("scheme") === "https" ? (
                <>
                  <Form.Item name="ca" label={t("CACertificate")} wrapperCol={{ span: 17 }}>
                    <TextArea placeholder={t("CACertificate")} autoSize={{ minRows: 5 }} />
                  </Form.Item>
                  <Form.Item name="clientCa" label={t("ClientCertificate")} wrapperCol={{ span: 17 }}>
                    <TextArea placeholder={t("ClientCertificate")} autoSize={{ minRows: 5 }} />
                  </Form.Item>
                  <Form.Item name="clientKey" label={t("ClientPrivateKey")} wrapperCol={{ span: 17 }}>
                    <TextArea placeholder={t("ClientPrivateKey")} autoSize={{ minRows: 5 }} />
                  </Form.Item>
                </>
              ) : null
            }
